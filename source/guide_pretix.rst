...
.. code-block:: ini
 ...
 [program:pretix]
 command=/home/<username>/.local/bin/gunicorn --reload --chdir /home/<username>/pretix/src --bind 0.0.0.0:8000 --workers 4 pretix.wsgi --name pretix --max-requests 1200 --max-requests-jitter 50
 autostart=true
 autorestart=true
 stopsignal=INT
...
.. code-block:: ini
 ...
 [program:pretix]
 command=/home/isabell/.local/bin/gunicorn --reload --chdir /home/isabell/pretix/src --bind 127.0.0.1:9000 --workers 4 pretix.wsgi --name pretix --max-requests 1200 --max-requests-jitter 50
 autostart=true
 autorestart=true
 stopsignal=INT
